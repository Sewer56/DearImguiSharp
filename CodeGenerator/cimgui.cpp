...
CIMGUI_API ImBoolVector* ImBoolVector_ImBoolVector(void)
{
    return IM_NEW(ImBoolVector)();
}
CIMGUI_API void ImBoolVector_destroy(ImBoolVector* self)
{
    IM_DELETE(self);
}
CIMGUI_API void ImBoolVector_Resize(ImBoolVector* self,int sz)
{
    return self->Resize(sz);
}
CIMGUI_API void ImBoolVector_Clear(ImBoolVector* self)
{
    return self->Clear();
}
CIMGUI_API bool ImBoolVector_GetBit(ImBoolVector* self,int n)
{
    return self->GetBit(n);
}
CIMGUI_API void ImBoolVector_SetBit(ImBoolVector* self,int n,bool v)
{
    return self->SetBit(n,v);
}
...
CIMGUI_API void igRenderColorRectWithAlphaCheckerboard(ImVec2 p_min,ImVec2 p_max,ImU32 fill_col,float grid_step,ImVec2 grid_off,float rounding,int rounding_corners_flags)
{
    return ImGui::RenderColorRectWithAlphaCheckerboard(p_min,p_max,fill_col,grid_step,grid_off,rounding,rounding_corners_flags);
}
CIMGUI_API void igRenderCheckMark(ImVec2 pos,ImU32 col,float sz)
{
    return ImGui::RenderCheckMark(pos,col,sz);
}
...
CIMGUI_API bool igTempInputTextScalar(const ImRect bb,ImGuiID id,const char* label,ImGuiDataType data_type,void* p_data,const char* format)
{
    return ImGui::TempInputTextScalar(bb,id,label,data_type,p_data,format);
}
CIMGUI_API bool igTempInputTextIsActive(ImGuiID id)
{
    return ImGui::TempInputTextIsActive(id);
}
...
CIMGUI_API void igImFontAtlasBuildRegisterDefaultCustomRects(ImFontAtlas* atlas)
{
    return ImFontAtlasBuildRegisterDefaultCustomRects(atlas);
}
